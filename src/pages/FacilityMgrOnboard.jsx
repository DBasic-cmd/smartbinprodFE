...
export default function FacilityMgrOnbordForm() {
            ...
            <div className="lg:w-7/12 w-full h-full flex flex-col  lg:px-36 px-8 py-12 bg-white">
                ...
                <div className='lg:my-8 my-12'>
                    ...
                    <div className="bg-white  w-full max-w-5xl">
                        <div className=" mb-8">
                            <h1 className="text-2xl lg:text-5xl  text-zinc-800 mb-2">As a Facility Manager</h1>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-5 mb-8">
                                ...
                                <div className='lg:col-span-2'>
                                    ...
                                    <NavLink to='/facilitymgrcreatepayerid'>
                                ...
                                <div>
                                    <label htmlFor="phoneNo" className="block text-sm font-medium text-zinc-700 mb-1">
                                        Phone number
                                    </label>
                                    <input
                                        type="tel"
