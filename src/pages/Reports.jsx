...
// Heroicon SVG Components (inline)
// Using 20x20 (w-5 h-5) or 24x24 (w-6 h-6) as base, can be overridden by className
// Outline style by default, fill for some notification icons
...
const defaultReportData = [
    // { id: '1', reportTitle: 'My Report', generationDate: '2023-06-10T11:36:00Z', period:"May-5- Jun07", reportType: 'Payment History' },
    // { id: '2', reportTitle: 'Report 2', generationDate: '2023-06-10T11:36:00Z', period:"May-5- Jun07", reportType: 'Bin Request' },
    // { id: '3', reportTitle: 'Report 3', generationDate: '2023-06-10T11:36:00Z', period:"May-5- Jun07", reportType: 'Waste pickup' },
    // { id: '4', reportTitle: 'Report 4', generationDate: '2023-06-10T11:36:00Z', period:"May-5- Jun07", reportType: 'Payment History' },
...
// const formatPeriod = (startDateString, endDateString) => {
...
//                 >
//                     <path
//                         d="M12.875 0.875L16 4M16 4L12.875 7.125M16 4H1"
//                         stroke="#828282"
//                         strokeWidth="1.5"
//                         strokeLinecap="round"
//                         strokeLinejoin="round"
...
const ReportsPage = () => {
    ...
    const handleGenerateReportSubmit = async (e) => {
        ...
        try {
            const { data } = await api.get(`${url}?ReportName=${newReportName}&ReportType=${selectedType}&StartDate=${newReportStartDate}&EndDate=${newReportEndDate}`)
            if (data.succeeded) {
                // Update reports list by re-fetching or adding locally
                // For this simulation, we'll add locally and assume the API updated the source
    ...
    return (
        ...
        <div>
          ...
          ${notification.type === 'success' ? 'bg-green-700' : 'bg-red-500'}`}
                      ...
                      ${report.reportType === 'Payment History' ? 'bg-green-100 text-green-800' :
                                                report.reportType === 'Bin Request' ? 'bg-green-100 text-green-800' :
