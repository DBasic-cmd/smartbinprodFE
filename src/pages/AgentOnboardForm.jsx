...
export default function AgentOnbordForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setNotification({ type: 'error', message: "Error creating new agent" });
        }
    };
            ...
            <div className="lg:w-7/12 w-full h-full flex flex-col  lg:px-36 px-8 py-12 bg-white">
                ...
                <div className='lg:my-8 my-12'>
                    ...
                    <div className="bg-white  w-full max-w-5xl">
                        <div className=" mb-8">
                            <h1 className="text-2xl lg:text-5xl  text-zinc-800 mb-2">As an Agent</h1>
