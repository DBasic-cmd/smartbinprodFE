                            ...
                            <div className="space-y-4 mb-8">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        name="userType"
                                        value="resident"
                                        checked={selectedOption === 'resident'}
                                        onChange={() => setSelectedOption('resident')}
                                        className="sr-only peer"
                                    />
                                    <label
                                        htmlFor="resident"
                                        className={`flex justify-between items-center w-full p-4 border rounded-lg cursor-pointer transition duration-150 ease-in-out peer-focus:ring-2 peer-focus:ring-offset-1 peer-focus:ring-green-700 ${selectedOption === 'resident'
                                            ? 'border-green-700 text-green-700 ring-1 ring-green-700'
                                            : 'border-zinc-300 text-zinc-800 hover:border-zinc-400'
                                            }`}
                                    >
                                        <span className="font-medium">A resident</span>
                                        <span
                                            className={`w-5 h-5 border rounded-full flex items-center justify-center transition-colors ${selectedOption === 'resident' ? 'border-green-700 bg-white' : 'border-zinc-400 bg-white'
                                                }`}
                                        >
                                            <span
                                                className={`w-2.5 h-2.5 rounded-full transition-transform duration-150 ease-in-out ${selectedOption === 'resident' ? 'bg-green-700 scale-100' : 'scale-0'
                                                    }`}
                                            ></span>
                                        </span>
                                    </label>
