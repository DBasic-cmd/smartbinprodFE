    ...
    return (
        <div >
            ...
            <div className='my-4 max-w-8xl pl-36 py-10'>
                <NavLink to="/corporateonboard"> <button className='flex flex-row items-center justify-centerp-4 rounded-2xl text-2xl'> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8 pr-2">
