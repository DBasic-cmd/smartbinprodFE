...
const Sidebar = ({ addkey }) => {
    ...
    const navItems = [
        ...
        { label: 'Report', icon: ReportIcon, route: { routes: ['/reports', '/paymentreport', '/wastereport', '/smartbinreport'], main: '/reports' } },
        { label: 'Service Configuration', icon: SettingsIcon, route: { routes: ['/service', '/notifications-settings', '/helpandsupport', "/subscription-settings"], main: '/service' } },
