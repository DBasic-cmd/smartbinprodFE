        ...
        <>
            ...
            <div className="flex flex-row gap-4 my-2  w-full py-4 border-zinc-200 ">
                ...
                <NavLink
                    ...
                    <p className={`items-left text-sm lg:text-md  justify-start p-2  ${location.pathname === '/subscription-settings' ? 'text-green-700 border-b-2  border-green-700' : 'text-zinc-700'}`}>
                        Subscriptions
                    </p>
                </NavLink>
            </div>
