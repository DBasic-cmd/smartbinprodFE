    ...
    const fetchFacilityMgr = async () => {
        try {
            ...
            if (data.success) {
                ...
                setDashboard(data.data.facilityMgrInfo);
                console.log(data.data.facilityMgrInfo, FacilityMgr)
    ...
    return (
        <div className="w-full bg-white p-4 flex items-center justify-between">
            <div className="flex items-center ">
                ...
                <p className="lg:text-sm text-[0.6rem]  text-zinc-500">{FacilityMgr?.address || "Complete your kyc registration"}</p>
...
export default FacilityMgrTopBar;